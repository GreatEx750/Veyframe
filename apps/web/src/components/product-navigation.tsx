  ...
  return (
    <aside className="navigation product-navigation">
      ...
      <nav aria-label="Primary navigation">
        <Link className={`nav-item ${active === "projects" ? "active" : ""}`} href="/projects" title="Projects"><NavigationIcon name="projects" /><span>Projects</span></Link>
        <Link className={`nav-item ${active === "studio" ? "active" : ""}`} href="/" title="Studio"><NavigationIcon name="studio" /><span>Studio</span></Link>
